...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1629573849);
user_pref("app.update.lastUpdateTime.background-update-timer", 0);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1629573969);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1629529359);
...
user_pref("extensions.zotero.export.translatorSettings", "{\"exportCharset\":\"UTF-8\",\"exportNotes\":true,\"exportFileData\":true,\"useJournalAbbreviation\":false}");
